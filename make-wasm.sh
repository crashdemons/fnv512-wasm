...
echo $W_FLAGS
emcc $W_FLAGS -s MODULARIZE=1 -s 'EXPORT_NAME="createFnv512Module"' -s WASM=1 -s EXTRA_EXPORTED_RUNTIME_METHODS='["cwrap"]' fnv512.cpp -o fnv512-wasm-dist/fnv512-wasm.js
